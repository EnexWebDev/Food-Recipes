          ...
          <div class="container my-5 py-5">
              <div class="row align-items-center g-5">
                  <div class="col-lg-6 text-center text-lg-start">
                      <h1 class="display-3 text-white animated slideInLeft"> <span class="text-warning ">Enjoy
                          Our</span><br />Delicious Meal</h1>
                      ...
                      <a href="" class="btn btn-outline-warning   py-sm-3 px-sm-5 me-3 ">Book A Table</a>
                  </div>
